        ...
        <div className="rec-right">
          ...
          <div className="rec-right-content">
            ...
            <div className="rec-stats">
              <div><div className="rec-stat-num">60+</div><div className="rec-stat-label">Active Jobs</div></div>
              <div><div className="rec-stat-num">40+</div><div className="rec-stat-label">Companies</div></div>
