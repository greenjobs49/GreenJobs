...
import { ArrowLeft, ArrowRight, Image, Upload, Settings, Eye, Globe, ChevronRight, Loader2, Sparkles, AlertCircle } from "lucide-react";
...
export default function CreateBlog() {
  ...
  const handleThumbnailUpload = async (e) => {
    ...
    try {
      setUploading(true);
      const res = await axios.post(`${API_BASE_URL}/api/blogs/upload-thumbnail`, formData, {
        headers: {
          ...
          <div className="cb-top-bar">
            <div>
              ...
              <h1 className="cb-page-title">
                <Sparkles size={28} color="#10b981" /> Create New Blog Post
              </h1>
            </div>
              ...
              <div className="cb-card">
                ...
                <div className="cb-card-body">
                  ...
                  <button type="submit" disabled={saving} className="cb-submit-btn">
                    {saving ? (
                      <><Loader2 className="animate-spin" size={20} /> Saving Post...</>
                    ) : (
                      <>Create Post <ArrowRight size={20} /></>
                    )}
                  </button>
                </div>
              </div>
