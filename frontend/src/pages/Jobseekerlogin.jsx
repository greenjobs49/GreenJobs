        ...
        <div className="js-left">
          ...
          <div className="js-tagline">
            ...
            <div className="js-stats">
              <div><div className="js-stat-num">12+</div><div className="js-stat-label">Active Jobs</div></div>
              <div><div className="js-stat-num">10+</div><div className="js-stat-label">Companies</div></div>
              <div><div className="js-stat-num">50+</div><div className="js-stat-label">Placements</div></div>
            </div>
          </div>
        </div>
