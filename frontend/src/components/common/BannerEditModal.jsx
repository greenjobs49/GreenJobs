...
const BannerEditModal = ({ isOpen, banner, onClose, onSave, isLoading }) => {
  ...
  /* ── Upload cropped blob to S3 ── */
  const handleBannerCropDone = async (blob, dataUrl) => {
    ...
    try {
      ...
      fd.append("bannerImage", blob, "banner.jpg");
    ...
    <>
      <div className="bem-overlay" onClick={onClose}>
        <style>{`
          ...
          /* Crop-pending indicator */
          .bem-crop-notice {
            display: inline-flex; align-items: center; gap: 8px;
            margin-top: 14px; padding: 10px 14px;
            background: #fefce8; border: 1px solid #fde68a;
            border-radius: 10px; font-size: 13px; color: #92400e; font-weight: 600;
          }
        ...
        <div className="bem-modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="bem-header">
            <div className="bem-header-left">
              <div>
                ...
                <div className="bem-subtitle">Upload and crop your centre banner image</div>
              </div>
            </div>
          ...
          <div className="bem-tabs">
            ...
            <button className={`bem-tab${tab === "size" ? " active" : ""}`} onClick={() => setTab("size")}>
              Size &amp; Style
            </button>
          </div>
                ...
                <>
                  ...
                  >
                    ...
                    <div className="bem-drop-sub">
                      {uploading ? "Please wait" : "PNG, JPEG, WEBP, GIF · Max 5MB · You'll crop it next"}
                    </div>
                    {!uploading && (
              ...
              {tab === "size" && (
                <div className="bem-size-row">
                  <div className="bem-field">
                    ...
                    <input name="height" type="text" className="bem-input" value={formData.height} onChange={handleChange} placeholder="75px" />
                  ...
                  <div className="bem-field">
                    ...
                    <input name="borderRadius" type="text" className="bem-input" value={formData.borderRadius} onChange={handleChange} placeholder="8px" />
                    <div className="bem-presets">
                      {radiusPresets.map(p => (
                        <button
                          key={p.value} type="button"
                ...
                <div className="bem-preview-section">
                  ...
                  <div className="bem-preview-frame">
                    <img
                      ...
                      style={{ height: formData.height || "75px", borderRadius: formData.borderRadius || "8px" }}
      ...
      {/* ── Banner crop modal (freeform — admin picks height via Size tab) ── */}
      <ImageCropperModal
        isOpen={bannerCropOpen}
        onClose={() => setBannerCropOpen(false)}
        onCrop={handleBannerCropDone}
        imageSrc={bannerRawSrc}
        aspectRatio={6 / 1}
        cropShape="rect"
        title="Crop Navbar Banner"
        hint="Wide crop (6:1) matches the navbar banner proportions"
      />
    </>
  );
};
